            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="parametre.php">parametre</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">mon equipes</h6>
                                </div>
                                <div class="card-body">
                                    <div class="">
                                        <section class="section section-lg section-bottom-md-70 bg-default">
                                            <div class="container">
                                                <h3 class="oh">
                                                    <span class="d-inline-block wow slideInUp" data-wow-delay="0s">Gestion des admins</span>
                                                </h3>
                                                <div class="row row-lg row-40 justify-content-center">
                                                    <!-- Ajout du style pour le scroll -->
                                                                ...
                                                                if ($result->num_rows > 0) {
                                                                    ...
                                                                    while ($row = $result->fetch_assoc()) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a href="edit_admin.php?id=<?= $row['id']; ?>" class="btn btn-warning btn-sm">Modifier</a>
                                                                            </td>
                                                                        </tr>
                                                                        <?php
                                                                    }
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="chart-pie pb-2">
                                        <a href="add_admin.php" class="btn btn-primary btn-block">Ajouter un nouvel administrateur</a>
                                    </div>
                                </div>
                            </div>
                        </div>
